...
class Monitor(object):
    ...
    def cpu():
        ...
        data = dict(
            percent_avg=psutil.cpu_percent(interval=0.1, percpu=False),  # 平均使用率
            # percent_per=max(psutil.cpu_percent(interval=0.code, percpu=True)),  # 单独使用率
